...
const (
	...
	GreetService_SayHelloBiderectionalStreaming_FullMethodName = "/greet_service.GreetService/SayHelloBiderectionalStreaming"
)
...
type GreetServiceClient interface {
	...
	SayHelloBiderectionalStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HelloRequest, HelloResponse], error)
}
...
func (c *greetServiceClient) SayHelloBiderectionalStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HelloRequest, HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], GreetService_SayHelloBiderectionalStreaming_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloBiderectionalStreamingClient = grpc.BidiStreamingClient[HelloRequest, HelloResponse]
...
type GreetServiceServer interface {
	...
	SayHelloBiderectionalStreaming(grpc.BidiStreamingServer[HelloRequest, HelloResponse]) error
...
func (UnimplementedGreetServiceServer) SayHelloBiderectionalStreaming(grpc.BidiStreamingServer[HelloRequest, HelloResponse]) error {
...
func _GreetService_SayHelloBiderectionalStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBiderectionalStreaming(&grpc.GenericServerStream[HelloRequest, HelloResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloBiderectionalStreamingServer = grpc.BidiStreamingServer[HelloRequest, HelloResponse]
